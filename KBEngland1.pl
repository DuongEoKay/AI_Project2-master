...
husband(Person,Wife):- married(Wife,Person), male(Person).
wife(Person,Husband):- married(Person,Husband), female(Person).
wife(Person,Husband):- married(Husband,Person), female(Person).
...
aunt(Person,NieceNephew):- child(NieceNephew,Parent), sibling(Person,Parent), female(Person).
aunt(Person,NieceNephew):- child(NieceNephew,Parent), sibling(Uncle,Parent), married(Uncle,Person), female(Person).
uncle(Person,NieceNephew):- child(NieceNephew,Parent), sibling(Person,Parent), male(Person).
uncle(Person,NieceNephew):- child(NieceNephew,Parent), sibling(Aunt,Parent), married(Person,Aunt), male(Person).
